  ...
  return (
    <div className="sticky top-12 z-40 flex flex-row items-center gap-2 mx-2 md:mx-0 bg-dark-500">
      ...
      {jwtPayload?.id !== userId && (
        <div className="flex flex-row justify-between items-center bg-gray-300 text-blurple-500 rounded-lg h-10 md:h-12 py-3 md:py-3 px-2 md:px-3 text-sm md:text-base">
