...
export default function AuctionDetailStickyHeader({
  ...
  return (
    <div className="sticky top-12 z-50 flex flex-row justify-between items-center bg-star-500 text-gray-200 rounded-lg py-3 px-6 mx-2 md:mx-0 text-sm md:text-base">
