...
export type UpdateDemandMutation = { __typename?: 'Mutation', updateDemand: { __typename?: 'DemandPreviewResponse', id: string, status: string, hidden: boolean, pending?: string | null, name: string, price: number, shippingCost: number, shippingType: string, totalPrice: number } };
...
export type UpdateOfferMutation = { __typename?: 'Mutation', updateOffer: { __typename?: 'OfferPreviewResponse', id: string, status: string, hidden: boolean, pending?: string | null, name: string, price: number, shippingCost: number, shippingType: string, totalPrice: number } };
...
export type UpdateSwapMutation = { __typename?: 'Mutation', updateSwap: { __typename?: 'SwapPreviewResponse', id: string, status: string, hidden: boolean, pending?: string | null, name0: string, name1: string, price: number, shippingCost: number, shippingType: string, totalPrice: number } };
